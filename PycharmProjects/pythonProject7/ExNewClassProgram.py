...
def TicketForm(self):
   ...
   # if TK == 2001:
    ...
    if TK == 2001:
        ticket1 = Ticket(TK, self.ticketcreator, self.firstname, self.surname, self.staffID, self.emailAd,
                         self.category, self.descript, self.priority, self.status, self.ticketresp)
        ticket1.printticket()
    if TK == 2002:
        ticket2 = Ticket(TK, self.ticketcreator, self.firstname, self.surname, self.staffID, self.emailAd,
                         self.category, self.descript, self.priority, self.status, self.ticketresp)
        ticket2.printticket()
    if TK == 2003:
        ticket3 = Ticket(TK, self.ticketcreator, self.firstname, self.surname, self.staffID, self.emailAd,
                         self.category, self.descript, self.priority, self.status, self.ticketresp)
        ticket3.printticket()
    if TK == 2004:
        ticket4 = Ticket(TK, self.ticketcreator, self.firstname, self.surname, self.staffID, self.emailAd,
                         self.category, self.descript, self.priority, self.status, self.ticketresp)
        ticket4.printticket()
    if TK == 2005:
        ticket5 = Ticket(TK, self.ticketcreator, self.firstname, self.surname, self.staffID, self.emailAd,
                         self.category, self.descript, self.priority, self.status, self.ticketresp)
        ticket5.printticket()
    print("---------------------------------------------------\n")
    statOv = statOv + 1
