...
print("Welcome to your help desk ticketing system.")
count = 0
TK = 2000
run = 0
...
def TicketForm():
    ...
    print("\nPlease choose a priority level for the ticket: \n")
    ...
    status = "Open"
    TK = TK + 1
    print("\nThank you", firstname, "your ticket is now open and appears as follows\n")
    print("---------------------------------------------------")
    print("Ticket Number: ",TK)
    print("Name: ", firstname, surname)
    print("Staff ID Number: ", staffID)
...
def ViewTicket():
    ...
    (tkv, a, b, c, d, e, f, g, h) = ("Open", 0, 0, 0, 0, 0, 0, 0, 0)
    global count
    global TK1, firstname1, surname1, staffID1, emailAd1, category1, descript1, priority1, status1
    global TK2, firstname2, surname2, staffID2, emailAd2, category2, descript2, priority2, status2
    global TK3, firstname3, surname3, staffID3, emailAd3, category3, descript3, priority3, status3
    ...
    print("1. Edit ticket priority")
    print("2. Edit ticket status")
    ...
    if w == 1:
        ...
        print("\nThis ticket's priority level has been updated")
        UpdatedTicket()

    if w == 2 and h == "Open":
        print("\nThis ticket's status is open, would you like to close the ticket?\n")
...
def UpdatedTicket():
    ...
    print("Ticket Status: ", h)
    print("---------------------------------------------------\n")
    input("Press Enter to return to ticket folder")
    ViewTicket()
